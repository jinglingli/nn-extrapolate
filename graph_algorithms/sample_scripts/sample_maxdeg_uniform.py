...
for train_graph in train_graphs:
	for test_min_n in test_min_ns:
		...
		for test_color in test_colors:
			data_name = f"maxdeg_uniform_{train_graph}_Ndim{node_dim}_Train_V{train_min_n}_{train_max_n}_C{train_color}_Test_V{test_min_n}_{test_max_n}_C{test_color}"
